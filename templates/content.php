...
// echo $counter_images_current_page;
    ...
    // <!-- Previous Page -->
        echo'<li class="page-item">
            <a class="page-link '.$previous_page_class($current_page) .'" href="index.php?page='.previousPage($current_page, $total_pages).'">Previous</a>
        </li>';
    // <!-- Iterrator pages -->
    ...
    // <!-- Next Page -->
    echo '<li class="page-item">                    
        <a class="page-link '. $next_page_class($current_page, $total_pages) .'"  
        href="'. nextPage($current_page, $total_pages) .'">Next</a>
    </li>';

    // <!-- Last Page -->
    echo '<li class="page-item">
        <a class="page-link '. $last_page_class($current_page, $total_pages) .'" href="'. nextPage($current_page, $total_pages, true) .'">Last Page</a>
    </li>';
